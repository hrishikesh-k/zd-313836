// This is the main file for the Netlify Build plugin proxy-to-recycling-tool.
...
export const onPreBuild = async function ({
  ...
  //
  //   [[plugins]]
  //   package = "netlify-plugin-proxy-to-recycling-tool"
  //     [plugins.inputs]
  //     foo = "bar"
  inputs,
  ...
  try {
    await netlifyConfig.redirects.push({
      "from": "/recycling-tool/*",
      "query": {},
      "to": `${netlifyConfig.build.environment.NEXT_PUBLIC_FNC_RECYCLING_TOOL_URL}:splat`,
      "status": 200,
      "force": true,
      "conditions": {},
      "headers": {}
  ...
  console.log(`\$process.env.NEXT_PUBLIC_FNC_RECYCLING_TOOL_URL : ${process.env.NEXT_PUBLIC_FNC_RECYCLING_TOOL_URL}`);
